...
public class Utils {
	...
	public static String buildUri(URIBuilder uriBuilder, String basePath, String path) throws UnsupportedEncodingException {
		return buildUri(uriBuilder, basePath, path, false);
	}

	public static String buildUri(URIBuilder uriBuilder, String basePath, String path, Boolean fullDetails) throws UnsupportedEncodingException {
		StringBuilder stringBuilder = new StringBuilder(uriBuilder.toString());
		stringBuilder.append(basePath);
		stringBuilder.append(path);
		if (fullDetails) {
			stringBuilder.append("?");
			stringBuilder.append("fullDetails=true");
		}
